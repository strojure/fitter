(ns strojure.fitter-example.app-system
...
(defn- run-example
  ...
  ([system-keys registry]
   (with-open [system! (system/init-system registry {:wrap-component wrap-component})]
     (-> (system/start! system! {:filter-keys system-keys})
